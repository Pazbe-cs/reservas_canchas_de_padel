...
import { sampleWithRequiredData } from '../cancha.test-samples';
...
describe('Cancha Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.canchas()[0]).toEqual(expect.objectContaining({ id: 16283 }));
  });

  describe('trackId', () => {
    it('should forward to canchaService', () => {
      const entity = { id: 16283 };
      jest.spyOn(service, 'getCanchaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCanchaIdentifier).toHaveBeenCalledWith(entity);
