...
/**
 * REST controller for managing {@link com.padel.backend.domain.Reserva}.
 */
@RestController
        ...
        Optional<Reserva> result = reservaRepository
            ...
            .map(existingReserva -> {
                ...
                if (reserva.getHoraInicio() != null) {
                    existingReserva.setHoraInicio(reserva.getHoraInicio());
                }
                if (reserva.getHoraFin() != null) {
                    existingReserva.setHoraFin(reserva.getHoraFin());
                }
