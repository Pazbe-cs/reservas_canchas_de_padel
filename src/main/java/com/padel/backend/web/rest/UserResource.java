...
import com.padel.backend.config.Constants;
import com.padel.backend.domain.User;
import com.padel.backend.repository.UserRepository;
import com.padel.backend.security.AuthoritiesConstants;
import com.padel.backend.service.MailService;
import com.padel.backend.service.UserService;
import com.padel.backend.service.dto.AdminUserDTO;
import com.padel.backend.web.rest.errors.BadRequestAlertException;
import com.padel.backend.web.rest.errors.EmailAlreadyUsedException;
import com.padel.backend.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.padel.backend.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
