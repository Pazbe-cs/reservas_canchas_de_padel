...
import static com.padel.backend.domain.UsuarioAsserts.*;
...
import com.padel.backend.domain.Usuario;
...
class UsuarioResourceIT {
    ...
    public static Usuario createEntity() {
        return new Usuario().nombre(DEFAULT_NOMBRE).email(DEFAULT_EMAIL).telefono(DEFAULT_TELEFONO);
    }
    ...
    public static Usuario createUpdatedEntity() {
        return new Usuario().nombre(UPDATED_NOMBRE).email(UPDATED_EMAIL).telefono(UPDATED_TELEFONO);
    }
    ...
    void putExistingUsuario() throws Exception {
        ...
        updatedUsuario.nombre(UPDATED_NOMBRE).email(UPDATED_EMAIL).telefono(UPDATED_TELEFONO);
    ...
    void fullUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.nombre(UPDATED_NOMBRE).email(UPDATED_EMAIL).telefono(UPDATED_TELEFONO);
